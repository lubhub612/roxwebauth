...
const Uranus = () => {
  ...
  const HandleData = async () => {
    const { data } = await HandlePopulation(1);
  ...
  const data = {
    ...
    overview: {
      content:
        "A cold, icy planet with towering mountains and glittering ice formations. Uranians have built a society that is both rugged and elegant, where towering ice formations blend seamlessly with modern architecture. The planet's icy mountains provide a unique challenge for horse racing enthusiasts, with courses that twist and turn through the frozen terrain.",
      source: "https://en.wikipedia.org/wiki/Uranus",
      image: "./galaxy/planet-uranus.png",
    },
    structure: {
      content:
        "The Uranian race course is a challenging underwater track that winds through towering kelp forests and across glittering coral reefs. The track is known for its unpredictable currents and sudden changes in water pressure, making it a true test of both jockey and horse.",
      source: "https://en.wikipedia.org/wiki/Uranus#Internal_structure",
      image: "./galaxy/planet-uranus-internal.svg",
      RaceCourses: [
        {
          url: "/images/locations/0fd4b8ae-0468-44da-bc9c-e58b45abc62d.jpeg",
        },
        {
          url: "/images/locations/5ba880ce-5b58-4592-9dae-4b8ed2ca70ee.jpeg",
        },
        {
          url: "/images/locations/7cff5f6c-229d-426f-b639-1071862e611e.jpeg",
        },
        {
          url: "/images/locations/8eb6ffc9-4de5-41f6-8c61-243cc3b41884.jpeg",
        },
        {
          url: "/images/locations/12e5f020-b77e-42b1-9b49-46c8130b774d.jpeg",
        },
        {
          url: "/images/locations/27a6756d-5bdb-4ba6-8db9-7a4226db2fd6.jpeg",
        },
        {
          url: "/images/locations/37f3b3ff-4564-4191-9264-aeba3a5a2464.jpeg",
        },
        {
          url: "/images/locations/129a543a-c019-4edf-bb1e-da3c1afd7039.jpeg",
        },
        {
          url: "/images/locations/422dbd70-0690-439f-8917-c36d7a5b331e.jpeg",
        },
        {
          url: "/images/locations/0429c975-6db3-4d9b-86cd-e69d6e04e9e9.jpeg",
        },
        {
          url: "/images/locations/950d5029-63e4-4539-8f0c-3bc0e633bcba.jpeg",
        },
        {
          url: "/images/locations/2686c1e6-2b17-4a25-a54f-25d429c343b7.jpeg",
        },
        {
          url: "/images/locations/3696d907-3e4e-400d-8ed0-9329412ffb91.jpeg",
        },
      ],
    },
    geology: {
      content:
        "The Uranians are a highly intelligent and technologically advanced species. They wear white space suits that allow them to survive the extreme conditions of space and their home planet. They have developed advanced spacecraft and interstellar communication devices, as well as advanced artificial intelligence and robotics technology. Their fighting style is based on precision strikes and sophisticated tactics, using advanced weaponry such as particle beams and EMPs.",
      source: "https://en.wikipedia.org/wiki/Uranus#Atmosphere",
      // image: "/images/species/uranus.jpeg",
      // geo: "./galaxy/planet-uranus-geology.png",
      // image: `/images/species/${population?.image}`,
      RaceCourses: [
        {
          url: "/images/species_slider/uranus/uranus.jpeg",
        },
        {
          url: "/images/species_slider/uranus/uranus_2.jpeg",
        },
        {
          url: "/images/species_slider/uranus/uranus_3.jpeg",
        },
        {
          url: "/images/species_slider/uranus/uranus_4.jpeg",
        },
        {
          url: "/images/species_slider/uranus/uranus_5.jpeg",
        },
        {
          url: "/images/species_slider/uranus/uranus_6.jpeg",
        },
        {
          url: "/images/species_slider/uranus/uranus_7.jpeg",
        },{
          url: "/images/species_slider/uranus/uranus_8.jpeg",
        },
      ],
    },
