...
const Neptune = () => {
  ...
  const HandleData = async () => {
    const { data } = await HandlePopulation(3);
  ...
  const data = {
    ...
    overview: {
      content:
        "A stunning, blue planet with towering mountains and glittering seas. Neptuneans have built a society that is deeply connected to the planet's vast oceans, with cities that stretch out over the water and blend seamlessly with the natural environment. The planet's towering mountains and glittering seas provide a stunning backdrop for horse racing enthusiasts, with courses that twist and turn through the breathtaking landscape.",
      source: "https://en.wikipedia.org/wiki/Neptune",
      image: "./galaxy/planet-neptune.png",
    },
    structure: {
      content:
        "The race course on Neptune is a high-speed track that winds around the planet's glittering seas and towering mountains. The course is known for its challenging terrain and unpredictable weather patterns, with sudden storms and extreme temperature changes adding an extra level of difficulty to the race.",
      source: "https://en.wikipedia.org/wiki/Neptune#Internal_structure",
      image: "./galaxy/planet-neptune-internal.svg",
      RaceCourses: [
        {
          url: "/images/locations/0e20937a-4681-427b-8420-af734131b6ec.jpeg",
        },
        {
          url: "/images/locations/1baaa8a3-f008-49ec-a09b-c9731ffa7f34.jpeg",
        },
        {
          url: "/images/locations/1eecdbbc-7bee-483e-b3bf-3a93332d199c.jpeg",
        },
        {
          url: "/images/locations/2e285a90-e921-4e07-a602-628e53b56521.jpeg",
        },
        {
          url: "/images/locations/4e53e1dc-e0d7-4af2-aca8-1eb7eba1edbd.jpeg",
        },
        {
          url: "/images/locations/8f2338bf-13ad-4a9d-a887-9b7fa6c5f0dc.jpeg",
        },
        {
          url: "/images/locations/32a5d6dd-2755-4d3c-8ba2-182a69b1a507.jpeg",
        },
        {
          url: "/images/locations/42b90549-1a0c-4088-9efe-a70e37ed0764.jpeg",
        },
        {
          url: "/images/locations/95d6ffd2-bc4a-445d-9acb-fb197803885e.jpeg",
        },
        {
          url: "/images/locations/448a3fa2-35a9-4a86-ac51-cce98217716e.jpeg",
        },
        {
          url: "/images/locations/472bd122-7f3c-4306-8ffe-569a559be708.jpeg",
        },
        {
          url: "/images/locations/6627a53d-c0fc-46f7-91d7-549fea16688d.jpeg",
        },
        {
          url: "/images/locations/9647e21a-7353-4a85-98f8-0840abd09b6b.jpeg",
        },
      ],
    },
    geology: {
      content:
        "The Neptunians are a proud and honorable species, with a deep connection to the oceans of their home planet. They wear blue armor that allows them to move through water with ease, and their ships are designed for underwater combat. They have developed advanced underwater technology, including submarines and torpedoes, and are skilled at using psychic abilities to control aquatic creatures. Their fighting style is based on hit-and-run attacks and surprise assaults, using weapons such as sonic disruptors and hydrodynamic projectiles.",
      source: "https://en.wikipedia.org/wiki/Neptune#Atmosphere",
      // image: "/images/species/neptune.jpeg",
      // geo: "./galaxy/planet-neptune-geology.png",
      // image: `/images/species/${population?.image}`,
      RaceCourses: [
        {
          url: "/images/species_slider/neptune/neptune.jpeg",
        },
        {
          url: "/images/species_slider/neptune/neptune_2.jpeg",
        },
        {
          url: "/images/species_slider/neptune/neptune_3.jpeg",
        },
        {
          url: "/images/species_slider/neptune/neptune_4.jpeg",
        },
        {
          url: "/images/species_slider/neptune/neptune_5.jpeg",
        },
        {
          url: "/images/species_slider/neptune/neptune_6.jpeg",
        },
        {
          url: "/images/species_slider/neptune/neptune_7.jpeg",
        },{
          url: "/images/species_slider/neptune/neptune_8.jpeg",
        },
      ],
