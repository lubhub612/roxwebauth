...
const Mercury = () => {
  ...
  const HandleData = async () => {
    const { data } = await HandlePopulation(2);
  ...
  const data = {
    ...
    overview: {
      content:
        "A small, rocky planet that has been transformed into a hub of technology and industry. The surface is covered in sprawling cities with towering skyscrapers, bustling factories, and high-tech research facilities. With its advanced infrastructure and cutting-edge technology, Mercury is a beacon of innovation in the galaxy.",
      source: "https://en.wikipedia.org/wiki/Mercury_(planet)",
      image: "./galaxy/planet-mercury.png",
    },
    structure: {
      content:
        "The race course on Mercury is a high-speed track with hairpin turns and steep inclines. The track is designed to test the limits of even the most skilled jockeys and their horses. The surrounding landscape is rocky and arid, with towering cliffs and narrow canyons providing a challenging backdrop to the race.",
      source:
        "https://en.wikipedia.org/wiki/Mercury_(planet)#Internal_structure",
      image: "./galaxy/planet-mercury-internal.svg",
      RaceCourses: [
        {
          url: "/images/locations/0a541149-10cd-4b4f-ba13-fcafc737f288.jpeg",
        },
        {
          url: "/images/locations/2cbe-4707-bf2f-8689c0f64f1a.jpeg",
        },
        {
          url: "/images/locations/3c5453c5-96a2-4ba4-a1b3-384a80c6e315.jpeg",
        },
        {
          url: "/images/locations/4bcd-4dc7-8563-9b74f131b1c0.jpeg",
        },
        {
          url: "/images/locations/5b72-4aa6-a4eb-6f5becf52e89.jpeg",
        },
        {
          url: "/images/locations/7cea1ac3-6e8e-4f4b-9c55-ed48f0368dfa.jpeg",
        },
        {
          url: "/images/locations/7f4c3817-7c75-4c34-9ee9-3d78cf613915.jpeg",
        },
        {
          url: "/images/locations/8b58-4ee4-b9a9-768b27ecc235.jpeg",
        },
        {
          url: "/images/locations/13a54e9f-b439-4961-a64a-4992edb162ff.jpeg",
        },
        {
          url: "/images/locations/38f22022-38cb-41ed-a9ab-263c41619672.jpeg",
        },
        {
          url: "/images/locations/38fee04c-63d0-4786-a84f-ecef12fc8aed.jpeg",
        },
        {
          url: "/images/locations/0169d7f4-b19e-45cc-9189-10b897bb887a.jpeg",
        },
        {
          url: "/images/locations/1292-4d62-b9c8-7e5280a66446.jpeg",
        },
      ],
    },
    geology: {
      content:
        "The Mercurians are a mysterious and elusive species, with a talent for espionage and sabotage. They wear specialized iron and leather suits that allow them to blend in with their surroundings and move silently. They have developed advanced stealth technology, including cloaking devices and holographic projections. Their fighting style is based on hit-and-run attacks and sabotage, using weapons such as plasma knives and sonic disruptors.",
      source: "https://en.wikipedia.org/wiki/Mercury_(planet)#Surface_geology",
      // image: "/images/species/mercury.jpeg",
      // geo: "./galaxy/planet-mercury-geology.png",
      // image: `/images/species/${population?.image}`,
      RaceCourses: [
        {
          url: "/images/species_slider/mercury/mercury.jpeg",
        },
        {
          url: "/images/species_slider/mercury/mercury_2.jpeg",
        },
        {
          url: "/images/species_slider/mercury/mercury_3.jpeg",
        },
        {
          url: "/images/species_slider/mercury/mercury_4.jpeg",
        },
        {
          url: "/images/species_slider/mercury/mercury_5.jpeg",
        },
        {
          url: "/images/species_slider/mercury/mercury_6.jpeg",
        },
        {
          url: "/images/species_slider/mercury/mercury_7.jpeg",
        },{
          url: "/images/species_slider/mercury/mercury_8.jpeg",
        },
      ],
