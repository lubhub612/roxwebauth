...
const Saturn = () => {
  ...
  const HandleData = async () => {
    const { data } = await HandlePopulation(7);
  ...
  const data = {
    ...
    overview: {
      content:
        "A stunning planet with breathtaking rings and glittering cities built into the rocky terrain. The planet's iconic rings are a testament to the ingenuity of the Saturnians, who have built a society that seamlessly blends with the natural environment. Saturn's unique topography provides a stunning backdrop for horse racing, with courses that weave between towering mountains and glittering cities.",
      source: "https://en.wikipedia.org/wiki/Saturn",
      image: "./galaxy/planet-saturn.png",
    },
    structure: {
      content:
        "The Saturnian race course is a glittering, futuristic track built into the rocky terrain of the planet's surface. The course features long, sweeping curves and sharp hairpin turns, with steep inclines and dizzying drops that test the skill and bravery of both jockey and horse.",
      source: "https://en.wikipedia.org/wiki/Saturn#Internal_structure",
      image: "./galaxy/planet-saturn-internal.svg",
      RaceCourses: [
        {
          url: "/images/locations/1a6a4a71-fdde-4e2d-b126-8523e51d3f70.jpeg",
        },
        {
          url: "/images/locations/6b4ded66-d617-49cc-ac82-c2b9e51cdc1d.jpeg",
        },
        {
          url: "/images/locations/9a0f8ba5-2455-438b-a88a-8ac3cbfc30f8.jpeg",
        },
        {
          url: "/images/locations/9fbcd21e-f0ba-4c77-a15f-7b3c69d2bd91.jpeg",
        },
        {
          url: "/images/locations/71a807fc-aea1-4b5a-af6a-4ba12f03b72e.jpeg",
        },
        {
          url: "/images/locations/99c6a4e3-bccb-4e3f-a20a-fb8a0288021d.jpeg",
        },
        {
          url: "/images/locations/116e77fa-cf21-4c4f-bbba-27e7fa379047.jpeg",
        },
        {
          url: "/images/locations/436fc443-708c-4e03-82ba-1b09415df27d.jpeg",
        },
        {
          url: "/images/locations/744e5802-2a4a-4f6e-8e0a-23ad542ff380.jpeg",
        },
        {
          url: "/images/locations/2558bb4e-f009-4bbb-b64f-8ef66a311d85.jpeg",
        },
        {
          url: "/images/locations/6808bcae-ffb7-478d-ac4f-911d4d759c02.jpeg",
        },
        {
          url: "/images/locations/9158cdc0-498c-48b3-a325-c83d697dbc2d.jpeg",
        },
        {
          url: "/images/locations/97557efe-0bc5-4bb8-b725-a64a398df7fb.jpeg",
        },
      ],
    },
    geology: {
      content:
        "The Saturnians are a hardy and resourceful species, with a deep respect for nature. They wear green and yellow suits that blend in with the landscapes of their planet, and their ships are designed to be sustainable and eco-friendly. They have developed advanced infrastructure and transportation technology, building vast networks of roads, bridges, and tunnels across their planet and beyond. Their fighting style is based on endurance and adaptability, using weapons such as smart missiles and magnetic shields.",
      source: "https://en.wikipedia.org/wiki/Saturn#Atmosphere",
      // image: "/images/species/saturn.jpeg",
      // geo: "./galaxy/planet-saturn-geology.png",
      // image: `/images/species/${population?.image}`,
      RaceCourses: [
        {
          url: "/images/species_slider/saturn/saturn.jpeg",
        },
        {
          url: "/images/species_slider/saturn/saturn_2.jpeg",
        },
        {
          url: "/images/species_slider/saturn/saturn_3.jpeg",
        },
        {
          url: "/images/species_slider/saturn/saturn_4.jpeg",
        },
        {
          url: "/images/species_slider/saturn/saturn_5.jpeg",
        },
        {
          url: "/images/species_slider/saturn/saturn_6.jpeg",
        },
        {
          url: "/images/species_slider/saturn/saturn_7.jpeg",
        },{
          url: "/images/species_slider/saturn/saturn_8.jpeg",
        },
      ],
