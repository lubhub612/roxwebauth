...
const Jupiter = () => {
  ...
  const HandleData = async () => {
    const { data } = await HandlePopulation(6);
  ...
  const data = {
    ...
    overview: {
      content:
        "A gas giant with a solid, habitable core surrounded by a thick atmosphere. The planet's massive size and intense gravity have created a unique environment, where Jovians have built towering cities that stretch towards the sky. With its thick, swirling atmosphere, Jupiter is the perfect location for horse racing enthusiasts who love a challenge.",
      source: "https://en.wikipedia.org/wiki/Jupiter",
      image: "./galaxy/planet-jupiter.png",
    },
    structure: {
      content:
        "The Jovian race course is a massive, circular track that winds around the planet's solid core. The track is suspended high above the planet's turbulent atmosphere, with jockeys and horses racing at breakneck speeds as they navigate tight turns and high-speed straightaways.",
      source: "https://en.wikipedia.org/wiki/Jupiter#Internal_structure",
      image: "./galaxy/planet-jupiter-internal.svg",
      RaceCourses: [
        {
          url: "/images/locations/1ae1e6a0-03a2-47c9-862a-99281fe0d7d6.jpeg",
        },
        {
          url: "/images/locations/2b5e3e7d-3922-4071-bb1b-1fdd22385025.jpeg",
        },
        {
          url: "/images/locations/4c7f0aaf-8fc1-4ad1-aa7f-929354f5b972.jpeg",
        },
        {
          url: "/images/locations/5ae2ec71-7537-413e-867d-fb122468fe87.jpeg",
        },
        {
          url: "/images/locations/7b7af1fa-9565-4d11-97ec-fd963b0d4113.jpeg",
        },
        {
          url: "/images/locations/7fd66551-d224-48fd-835b-cbc794638d3d.jpeg",
        },
        {
          url: "/images/locations/51b6eb17-d298-4ffe-bc85-43d8126c11a1.jpeg",
        },
        {
          url: "/images/locations/75d010d1-e7be-4b16-b122-3855d8f5124c.jpeg",
        },
        {
          url: "/images/locations/080ef1cc-f9ae-421b-a01b-873b7f5fd8bb.jpeg",
        },
        {
          url: "/images/locations/0173ebf8-7ad5-48a7-b9e2-c9708ff7547c.jpeg",
        },
        {
          url: "/images/locations/690e4561-422e-405b-a000-640e8404ce71.jpeg",
        },
        {
          url: "/images/locations/6995d157-1db0-415e-82bc-8ddad5e23352.jpeg",
        },
        {
          url: "/images/locations/7178a9bd-26c4-4b7c-9ed8-be46c9692fca.jpeg",
        },
      ],
    ...
    geology: {
      content:
        "The Jovians are a highly evolved and powerful species, with a deep connection to the energy of the universe. They wear bio-luminescent suits that glow with a brilliant light, and their ships are powered by advanced energy systems. They have developed advanced energy and propulsion technology, enabling them to travel at incredible speeds through space and harness the power of stars. Their fighting style is based on overwhelming force and energy manipulation, using weapons such as energy beams and plasma blasts.",
      source:
        "https://en.wikipedia.org/wiki/Jupiter#Great_Red_Spot_and_other_vortices",
      // image: "/images/species/jupiter.jpeg",
      // geo: "./galaxy/planet-jupiter-geology.png",
      // image: `/images/species/${population?.image}`,
      RaceCourses: [
        {
          url: "/images/species_slider/jupiter/jupiter.jpeg",
        },
        {
          url: "/images/species_slider/jupiter/jupiter_2.jpeg",
        },
        {
          url: "/images/species_slider/jupiter/jupiter_3.jpeg",
        },
        {
          url: "/images/species_slider/jupiter/jupiter_4.jpeg",
        },
        {
          url: "/images/species_slider/jupiter/jupiter_5.jpeg",
        },
        {
          url: "/images/species_slider/jupiter/jupiter_6.jpeg",
        },
        {
          url: "/images/species_slider/jupiter/jupiter_7.jpeg",
        },
        {
          url: "/images/species_slider/jupiter/jupiter_8.jpeg",
        },
      ],
    },
