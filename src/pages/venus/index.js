...
const Venus = () => {
  ...
  const HandleData = async () => {
    const { data } = await HandlePopulation(4);
  ...
  const data = {
    ...
    overview: {
      content:
        "A lush, tropical planet with stunning landscapes and vibrant cities. The planet is covered in sprawling rainforests and vast oceans, home to a wide variety of exotic flora and fauna. Venetians have built magnificent cities that seamlessly blend with the natural environment, creating a unique and harmonious society.",
      source: "https://en.wikipedia.org/wiki/Venus",
      image: "./galaxy/planet-venus.png",
    },
    structure: {
      content:
        "The Venusian race course is a twisting and turning track that winds through dense forests, over rushing rivers, and across glittering lakes. The course is known for its treacherous terrain and unpredictable weather, with sudden rainstorms and fierce winds adding an extra level of difficulty to the race.",
      source: "https://en.wikipedia.org/wiki/Venus#Internal_structure",
      image: "./galaxy/planet-venus-internal.svg",
      RaceCourses: [
        {
          url: "/images/locations/0a0d67bd-439c-4dd4-a7ed-76d59d0dfa4f.jpeg",
        },
        {
          url: "/images/locations/0ea70590-7792-4c66-86d2-6a6cdbe6a11f.jpeg",
        },
        {
          url: "/images/locations/2c4bbf73-65a6-4736-b545-f2e1d5dec385.jpeg",
        },
        {
          url: "/images/locations/2cee7aab-162e-4bb9-809c-bb04330e989c.jpeg",
        },
        {
          url: "/images/locations/3ca4108e-1922-4533-bc47-34b146aec59a.jpeg",
        },
        {
          url: "/images/locations/3cefcac5-6f14-47ed-9940-0a2e16e05088.jpeg",
        },
        {
          url: "/images/locations/5d8b8603-c25f-4715-900b-23360e562776.jpeg",
        },
        {
          url: "/images/locations/5d7869b8-e51b-4efb-8737-a2f1d470d5d7.jpeg",
        },
        {
          url: "/images/locations/6a8bdf6b-c177-4f1c-aabf-95087907326e.jpeg",
        },
        {
          url: "/images/locations/9b9b6c98-9aa8-4738-9b39-e5952d047a89.jpeg",
        },
        {
          url: "/images/locations/9b82d246-e398-43da-81bb-a7b0627b60ee.jpeg",
        },
        {
          url: "/images/locations/69c2ed05-5127-4725-b9ad-12cd70667371.jpeg",
        },
        {
          url: "/images/locations/81cbcc5f-0adb-4f33-b8f0-f6e08a43cf0f.jpeg",
        },
      ],
    },
    geology: {
      content:
        "The Venusians are a sophisticated and glamorous species, with a love for beauty and luxury. They wear golden armor that glitters in the light of their planet's sun, and their ships are designed for elegance as well as function. They have developed advanced manufacturing and crafting technology, producing some of the most beautiful and exquisite objects in the galaxy, as well as advanced energy weapons and shields. Their fighting style is based on precision strikes and overwhelming force, using weapons such as laser cannons and plasma torpedoes.",
      source: "https://en.wikipedia.org/wiki/Venus#Surface_geology",
      // image: "./galaxy/planet-venus.png",
      // geo: "./galaxy/planet-venus-geology.png",
      // image: `/images/species/${population?.image}`,
      RaceCourses: [
        {
          url: "/images/species_slider/venus/venus.jpeg",
        },
        {
          url: "/images/species_slider/venus/venus_2.jpeg",
        },
        {
          url: "/images/species_slider/venus/venus_3.jpeg",
        },
        {
          url: "/images/species_slider/venus/venus_4.jpeg",
        },
        {
          url: "/images/species_slider/venus/venus_5.jpeg",
        },
        {
          url: "/images/species_slider/venus/venus_6.jpeg",
        },
        {
          url: "/images/species_slider/venus/venus_7.jpeg",
        },
        {
          url: "/images/species_slider/venus/venus_8.jpeg",
        },
      ],
    },
