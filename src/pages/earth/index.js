...
const Earth = () => {
  ...
  const HandleData = async () => {
    const { data } = await HandlePopulation(8);
  ...
  const data = {
    ...
    overview: {
      content:
      "A diverse and vibrant world teeming with an incredible array of plant and animal life, Earth is home to humans, the dominant intelligent species on the planet. Earth is one of eight planets in the ROX universe, each with their own unique inhabitants and cultures. The planet is dotted with sprawling metropolises and idyllic rural landscapes.",
      source: "https://en.wikipedia.org/wiki/Earth",
      image: "./galaxy/planet-earth.png",
    },
    structure: {
      content:
        "Horse racing courses around the world offer diverse settings, from urban centers to rural areas, each with unique characteristics and challenges. Modeled after oval racecourses, these tracks have smooth surfaces and grandstands for spectators. Racing on these tracks is an exciting experience, whether in the heart of New York City or on the outskirts of Paris.",
      source: "https://en.wikipedia.org/wiki/Earth#Internal_structure",
      // image: "./galaxy/planet-earth.png",
      RaceCourses: [
        {
          url: "/images/locations/earth/earth.jpeg",
        },
        {
          url: "/images/locations/earth/earth_1.jpeg",
        },
        {
          url: "/images/locations/earth/earth_2.jpeg",
        },
        {
          url: "/images/locations/earth/earth_3.jpeg",
        },
        {
          url: "/images/locations/earth/earth_4.jpeg",
        },
        {
          url: "/images/locations/earth/earth_5.jpeg",
        },
        {
          url: "/images/locations/earth/earth_6.jpeg",
        },
        {
          url: "/images/locations/earth/earth_7.jpeg",
        },
        {
          url: "/images/locations/earth/earth_8.jpeg",
        },
      ],
    },
    geology: {
      content:
              "Humans have inhabited Earth for thousands of years, adapting and innovating over time. The planet's history is marked by millions of years of evolution and catastrophic events, such as asteroid impacts and ice ages. The rise and fall of the dinosaurs was a significant event, followed by the emergence of humans as the dominant species. Wars and conflicts have shaped human history, but progress has also been made through technological and scientific advancements. Today, diverse cultures and societies coexist with the natural world on Earth.",
      source: "https://en.wikipedia.org/wiki/Earth#Surface",
      // image: "./galaxy/planet-earth.svg",
      // geo: "./galaxy/planet-earth-geology.png",
      RaceCourses: [
        {
          url: "/images/species_slider/earth/earth.jpeg",
        },
        {
          url: "/images/species_slider/earth/earth_2.jpeg",
        },
        {
          url: "/images/species_slider/earth/earth_3.jpeg",
        },
        {
          url: "/images/species_slider/earth/earth_4.jpeg",
        },
        {
          url: "/images/species_slider/earth/earth_5.jpeg",
        },
        {
          url: "/images/species_slider/earth/earth_6.jpeg",
        },
        {
          url: "/images/species_slider/earth/earth_7.jpeg",
        },
        {
          url: "/images/species_slider/earth/earth_8.jpeg",
        },
      ],
    },
