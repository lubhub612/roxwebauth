...
export default function RosterList() {
  const { handleAllHorse, allHorse, setAllHorse } = useContext(GlobalContext);
  ...
  console.log("🚀 ~ file: StudList.js ~ line 16 ~ RosterList ~ search", search);
  useEffect(() => {
    handleAllHorse();
  }, []);
      ...
      <div className="roster-list">
        <div className="container">
          <div className="roster-list-inner">
            ...
            <p>
              {t(
                "This is the stud farm, where you can look for the perfect match for your filly or mare. Below you will see all of the colts and stallions currently in the stud farm and ready to breed."
              )}
            </p>
            {/* </div> */}
                    ...
                    <div className="roster-bottom">
                      ...
                      <div className="roster-bottom-right">
                        ...
                        <button className="btn">
                          <Link
                            href={`/select-mate?id=${horseInfoData?.horse_id}`}
                          >
                            <a>{t("Select Mate")}</a>
                          </Link>
                        </button>
            ...
            <div className="roster-add-horse">
              <div className="roster-add-img">
                ...
                <strong>
                  ...
                  {t("Add a Racehorse to Stud Farm")}
                </strong>
              </div>
