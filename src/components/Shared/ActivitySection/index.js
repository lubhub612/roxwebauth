...
import MainDropDown from "../MainDropDown/index";
import ProfileStatsChart from "../ProfileStatsChart/index";
    ...
    switch (activity.paymentName) {
      ...
      default:
        return (
          <div className="price-div">
            <div>
              {activity.basePrice} {activity.paymentName}
            </div>
          </div>
        );
    }
